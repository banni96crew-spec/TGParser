...
_RAW: dict[str, tuple[str, bool]] = {
    ...
    "R14-FP07": (
        "Добрый день, нужны кому-то услуги разработчика? "
        "Пишу парсеры, сайты, боты и много чего еще",
        False,
    ),
    "R14-FP08": ("А мне нужно отгрузить текущие заказы. И что теперь", False),
    "R14-FP09": (
        "Удаленка в Ozon Support! Без опыта. "
        "Ищем специалистов поддержки пользователей и партнеров Ozon",
        False,
    ),
    "R14-FP10": (
